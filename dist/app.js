(() => {
  ...
  var require_compileTemplate = __commonJS({
    "node_modules/.pnpm/mithril@2.2.2/node_modules/mithril/pathname/compileTemplate.js"(exports, module) {
      ...
      module.exports = function(template) {
        ...
        var keys = [];
        var regexp = new RegExp("^" + templateData.path.replace(/:([^\/.-]+)(\.{3}|\.(?!\.)|-)?|[\\^$*+.()|\[\]{}]/g, function(m4, key, extra) {
          if (key == null)
            return "\\" + m4;
  ...
  var require_router = __commonJS({
    "node_modules/.pnpm/mithril@2.2.2/node_modules/mithril/api/router.js"(exports, module) {
      ...
      module.exports = function($window, mountRedraw) {
        ...
        route.Link = {
          view: function(vnode) {
            var child = m4(vnode.attrs.selector || "a", censor(vnode.attrs, ["options", "params", "selector", "onclick"]), vnode.children);
  ...
  // node_modules/.pnpm/classies@1.0.5/node_modules/classies/index.js
  var require_classies = __commonJS({
    "node_modules/.pnpm/classies@1.0.5/node_modules/classies/index.js"(exports, module) {
  ...
  var import_classies = __toESM(require_classies(), 1);

  // src/util.js
  var SpinnerEl = (element, ms = 100) => {
    let el = element;
    let step = 0;
    let timer;
    const steps = {
  ...
  // src/components.js
  var TextInput = () => ({
    view: ({ attrs: { placeholder, value, onInput } }) => (0, import_mithril.default)("input", {
      type: "text",
      placeholder,
      value,
  ...
  var Spinner = () => {
    ...
    return {
      ...
      view: () => (0, import_mithril.default)("div.spinner")
    };
  };
  var Card = () => ({
    view: ({ attrs: { profile, onClick, isStaged, showHeader } }) => (0, import_mithril.default)("div.card.max-width-3", {
      onclick: profile.visible && onClick,
      className: (0, import_classies.default)({
        "-staged": isStaged,
        "clickable": profile.visible,
        "opacity-50": !profile.visible
      })
    }, showHeader && (0, import_mithril.default)("header.overflow-hidden", (0, import_mithril.default)("a.neutral", { href: profile.profileurl }, profile.profileurl)), (0, import_mithril.default)("div.flex.select-none", (0, import_mithril.default)("img.mr-2", {
      style: { width: "40px" },
      src: profile.avatar
    }), (0, import_mithril.default)("span", profile.personaname), isStaged && (0, import_mithril.default)("span.pl-1", "\u2713")))
  });
  var Panel = () => ({
    view: ({ attrs: { stagedCount } }) => (0, import_mithril.default)("div.panel", (0, import_mithril.default)("div", stagedCount + " friends selected"), (0, import_mithril.default)("button", "Compare Libraries"))
  });

  // src/api.js
  var import_mithril2 = __toESM(require_mithril(), 1);
  var API_URL = "http://localhost:8080";
  var endpoint = (action) => `${API_URL}/${action}`;
  async function getProfiles(steamid) {
    let [profiles, error] = [{}, ""];
    const url = endpoint("getProfiles");
    try {
      const res = await import_mithril2.default.request({ url, params: { steamid } });
      if (res.error)
        throw res.error;
      profiles = res.data[0];
    } catch (e) {
  ...
  function App({ attrs: { actions } }) {
    let steamid = "";
    return {
      view: ({ attrs: { state } }) => (0, import_mithril3.default)("div", (0, import_mithril3.default)("section", (0, import_mithril3.default)("form", {
        onsubmit: async (ev) => {
          ev.preventDefault();
          actions.setProfiles({});
      ...
      }, (0, import_mithril3.default)(TextInput, {
        placeholder: "enter steamid",
        onInput: (v) => steamid = v
      }))), state.loading && (0, import_mithril3.default)(Spinner), (0, import_mithril3.default)("section", state.error && (0, import_mithril3.default)("div.error", state.error), state.user && [
        (0, import_mithril3.default)("h2", "User"),
        (0, import_mithril3.default)(Card, { profile: state.user, showHeader: true })
      ]), (0, import_mithril3.default)("section", state.friends && state.friends.length > 0 && [
        (0, import_mithril3.default)("h2", "Friends"),
        (0, import_mithril3.default)("div.grid.grid-columns.gap-1", state.friends.map((friend) => (0, import_mithril3.default)(Card, {
          key: friend.steamid,
          profile: friend,
      ...
      ]), state.staged.length > 1 && (0, import_mithril3.default)(Panel, { stagedCount: state.staged.length - 1 }))
    };
  }
  import_mithril3.default.mount(document.getElementById("app"), () => {
    ...
    return {
      view: () => (0, import_mithril3.default)(App, { state, actions })
    };
  });
})();
